...
if(strlen($_SESSION['alogin'])==0) {   
    ...
    if(isset($_POST['submit'])) {
        ...
        $ret=mysqli_query($connect, "INSERT INTO sessions(session) 
            VALUES('$session')");

        if($ret) {
            $_SESSION['msg']="Session Registered Successfully !!";
        }
        else {
            $_SESSION['msg']="Error : Session  not Register";
        }
    }
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="session.php">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Add Session</h3>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="session" name="session" onBlur="userAvailability()" placeholder="Session.." required />
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <?php
                                    $sql = mysqli_query($connect, "SELECT * FROM sessions");
                                    $cnt = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post" action="delete-session.php">
                                                    <input type="hidden" name="session" value="<?php echo htmlentities ($row['session'])?>" >
                                                    <a href="session.php?id=&del=delete" onClick="return confirm('Are you sure you want to delete?')">
